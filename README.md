...
**DST App** — коробочное (on-premise) решение для организации корпоративных коммуникаций, сочетающее простоту и скорость привычных потребительских мессенджеров с мощными инструментами для совместной работы на уровне Enterprise-платформ.

<img src="https://repository-images.githubusercontent.com/1202733006/3b070da4-105e-4b54-b3e4-444796d5b299" alt="DST App">
...
Полная документация по установке, настройке, администрированию и использованию API:
